// // Better Dropdown Component - Fixed version
...
// const Dropdown = ({
//   label,
//   columns = [], // Now columns is an array of column data
//   mobile = false,
//   compact = false,
// }) => {
...
//   // Handle toggle for both mobile and desktop
//   const handleToggle = () => {
//     setOpen(!open);
//   };
...
//   // Get grid columns class - FIXED: Using object mapping instead of string interpolation
...
//             </div>
//           ) : (
//             // Desktop: Display as columns - FIXED grid classes
