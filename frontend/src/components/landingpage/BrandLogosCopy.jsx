...
import Tshepojeanslogo from "../../assets/logos/tshepojeanslogo.jpeg";
import ThesisLogo from "../../assets/logos/thesisLogo.jpg";
import SteezkillaLogo from "../../assets/logos/steezkillaLogo.png";

const BrandLogos = () => {
  const brands = [
    { src: SjambokLogo, alt: "Sjambok" },
    { src: ThesisLogo, alt: "Thesis" },
    { src: SteezkillaLogo, alt: "Steezkilla" },
    { src: Tshepojeanslogo, alt: "Tshepo Jeans" },
  ];
  ...
  //           slider.scrollLeft = 0; // reset for infinite loop
  //           scrollAmount = 0;
  //         }
  //       }
  //     }, 20); // smooth speed
  ...
  //       setInterval(() => {
  //         if (slider) slider.scrollLeft += speed;
  //       }, 20);
